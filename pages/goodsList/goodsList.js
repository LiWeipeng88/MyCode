...
Page({
  ...
  onLoad: function (e) {
    ...
    if (e) {
      ...
      wx.request({
        ...
        data: {
          map: 'applet_sequence_activity_cate_title',
          cate_id: cate_id
        },
        success: function (res) {
          console.log(res)
          that.setData({
            sk_name: res.data.data.sk_name
          })
          wx.setStorageSync("sk_name", res.data.data.sk_name)
        },
  ...
  onReachBottom1: function () {
    ...
    wx.request({
      url: app.globalData.requestUrl,
      data: {
        map: 'applet_sequence_activity_odetail',
        id: that.data.id,
        page_num: page_num,
  ...
  onShareAppMessage: function () {
    ...
    if (tuan_id != '') {
      ...
      //+ tuan_id
      path = '/pages/goodsList/goodsList?id=' + id + '&groupId=' + tuan_id + '&cate_id=' + cate_id;
    } else {
      path = '/pages/goodsList/goodsList?cate_id=' + cate_id
    }
    ...
    var sk_name = that.data.sk_name ? that.data.sk_name : wx.getStorageSync("sk_name")
